...
class _ProductStatusState extends State<ProductStatus> {
  ...
  // ▼▼▼▼▼▼ [ CODE ที่แก้ไข 1/3: ปรับสถานะข้อความ ] ▼▼▼▼▼▼
  ...
  Widget build(BuildContext context) {
    ...
    // (ส่วน Logic การสร้าง imageOrIconWidget เหมือนเดิม)
      ...
      imageOrIconWidget = ClipRRect(
        ...
        child: Image.network(
          ...
          errorBuilder: (context, error, stackTrace) {
            print("Error loading pickup image: $error");
            ...
            // --- Tracking Steps ---
             Padding(
               ...
               child: Row(
                 ...
                 children: <Widget>[
                    // ▼▼▼▼▼▼ [ CODE ที่แก้ไข 3/3: ปรับ Widget TrackingStep ] ▼▼▼▼▼▼
